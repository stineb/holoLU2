fluc_r1 <- read.table( "data/fluc_r1_holoLU2.dat", col.names=c("year","fluc") )
fluc_r2 <- read.table( "data/fluc_r2_holoLU2.dat", col.names=c("year","fluc") )
fluc_r3 <- read.table( "data/fluc_r3_holoLU2.dat", col.names=c("year","fluc") )
fluc_r4 <- read.table( "data/fluc_r4_holoLU2.dat", col.names=c("year","fluc") )
fluc_r5 <- read.table( "data/fluc_r5_holoLU2.dat", col.names=c("year","fluc") )
fluc_r7 <- read.table( "data/fluc_r7_holoLU2.dat", col.names=c("year","fluc") )
fluc_r8 <- read.table( "data/fluc_r8_holoLU2.dat", col.names=c("year","fluc") )
fluc_r9 <- read.table( "data/fluc_r9_holoLU2.dat", col.names=c("year","fluc") )
fluc_r1l <- read.table( "data/fluc_r1lholoLU2.dat", col.names=c("year","fluc") )
...
## save to file
save( fluc, fluc_rdc, mintotc, maxtotc, file="data/fluc_holoLU2.Rdata" )
...
save( fluc_per_holocene, fluc_per_lastmill, file="data/fluc_per.Rdata")

...
save( pt_lpx_outarr, dc_pt_per_lpx, file="data/dc_peat_lpx_lastmill.Rdata" )
...
save( pt_outarr, dc_pt_per_mean_lhnfix, file="data/pt_outarr_lastmill.Rdata" )
...
## -----------------------------------------------------------------------------------------
pdf("fig/cbal_pt_barplot_lastmill_holoLU2.pdf", width=10, height=6 )

...
################
  ...
  filn <- paste( "fig/fig_LUC_maps/LUC_map_holocene_7_5.pdf", sep="" )
  ...
  filn <- paste( "fig/fig_LUC_maps/LUC_map_holocene_3_1.pdf", sep="" )
  pdf( filn, width=sum(widths), height=sum(heights) )
  ...
  dev.off()
    ...
    for (i in 1:nper){
      ...
      pdf( filn, width=sum(widths), height=sum(heights) )
        ...
        text(-173,-56,paste("HYDE 3.1,",as.character(period_margins[i+1]),"CE"),cex=1.5,adj=c(0,0))
        axis( 2, at=lat.labels, lab=do.call(expression,a), cex.axis=0.8, lwd=1.5 )
        axis( 2, at=lat.short, lab=F, lwd=1, tck=-0.01 )
        ...
        text(-173,-56,paste("HYDE 3.2,",as.character(period_margins[i+1]),"CE"),cex=1.5,adj=c(0,0))
        axis( 2, at=lat.labels, lab=do.call(expression,a), cex.axis=0.8, lwd=1.5 )
        axis( 2, at=lat.short, lab=F, lwd=1, tck=-0.01 )
        ...
        text(-173,-56,paste("KK10,",as.character(period_margins[i+1]),"CE"),cex=1.5,adj=c(0,0))
        axis( 2, at=lat.labels, lab=do.call(expression,a), cex.axis=0.8, lwd=1.5 )
        axis( 2, at=lat.short, lab=F, lwd=1, tck=-0.01 )
        ...
        text(-173,-56,paste("KK10D,",as.character(period_margins[i+1]),"CE"),cex=1.5,adj=c(0,0))
        axis( 2, at=lat.labels, lab=do.call(expression,a), cex.axis=0.8, lwd=1.5 )
        axis( 2, at=lat.short, lab=F, lwd=1, tck=-0.01 )
